...
import { PhotosSitePage } from "@/features/gallery/photos-site-page";
...
export default async function GalleryPhotosPage({
  ...
  const g = dict.pages.gallery;
  const hero = resolveGalleryPageHeroLabels(settings, locale, "photos");
